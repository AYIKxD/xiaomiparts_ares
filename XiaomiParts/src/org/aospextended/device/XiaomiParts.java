...
public class XiaomiParts extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mPrefs = Utils.getSharedPreferences(requireActivity());

        PreferenceCategory gestures = (PreferenceCategory) findPreference("gestures_category");
	...
	mCustomTrigger = findPreference("custom_trigger");
        ...
        PreferenceCategory misc = (PreferenceCategory) findPreference("triggers_category");
        ...
        mLedInCalls.setChecked(Utils.getIntSystem(requireActivity(), "led_in_calls", 1) == 1);
...
/*        PreferenceCategory vib_strength = (PreferenceCategory) findPreference("vib_strength_category");
...
*/
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mTriggers) {
            TriggerService.getInstance(requireActivity()).show();
            return true;
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mTriggerSound) {
            ...
            Settings.System.putInt(requireActivity().getContentResolver(), "trigger_sound", ((Boolean) newValue) ? 1 : 0);
            return true;
        }
        ...
        if (preference == mTriggerSoundType) {
            ...
            Settings.System.putString(requireActivity().getContentResolver(), "trigger_sound_type", (String) newValue);
        ...
        if (preference == mLedDisco) {
            ...
            LedUtils ledUtils = LedUtils.getInstance(requireActivity());
        ...
        if (preference == mLedInCalls) {
            Utils.putIntSystem(requireActivity(), "led_in_calls", ((Boolean) newValue) ? 1 : 0);
            return true;
        }
        return true;
    }
