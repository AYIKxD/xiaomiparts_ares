...
public class DozeSettingsFragment extends PreferenceFragmentCompat implements OnPreferenceChangeListener,
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        SharedPreferences prefs = Utils.getSharedPreferences(requireActivity());
        ...
        mAlwaysOnDisplayPreference.setChecked(DozeUtils.isAlwaysOnEnabled(requireActivity()));
...
//        if (!DozeUtils.getProxCheckBeforePulse(requireActivity())) {
            getPreferenceScreen().removePreference(proximitySensorCategory);
//        }

        // Hide AOD if not supported and set all its dependents otherwise
        if (!DozeUtils.alwaysOnDisplayAvailable(requireActivity())) {
    ...
    public static class HelpDialogFragment extends DialogFragment {
        ...
        public void onCancel(DialogInterface dialog) {
            Utils.getSharedPreferences(requireActivity())
                    .edit()
